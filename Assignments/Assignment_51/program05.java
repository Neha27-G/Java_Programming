/*
    ...
    all files along with its name and size of each file into newly craeted file "Marvellous.txt"
*/
...
class Demo
{
    void WriteFileData(String dir, String Filename) throws IOException
    {
        ...
        System.out.println("Files Contents successfully writtern inside Marvellous.txt with file names & sizes");
    }
}
